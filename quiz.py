...
if "question" not in st.session_state:
  ...
  QUIZ_CSV='https://docs.google.com/spreadsheets/d/e/2PACX-1vSHVUd8XLYRNUyAaA1xomJe4Y5Ki_O979q8qss5FY5olRh4uUoZmXExDwiHRrBmpbNTADGPjMDGqque/pub?gid=0&single=true&output=csv'
  df=load_csv(QUIZ_CSV)
  row=df.sample()
